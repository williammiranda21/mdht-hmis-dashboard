...
export interface EvaCheck {
  ...
  label: string;
  slug: string;          // short readable key for the CSV export's error column
                         // (user request 2026-08-13: 'eva_2' told staff nothing)
...
export const EVA_CHECKS: EvaCheck[] = [
  // ── Household integrity ────────────────────────────────────────────────────
  {
    id: '2', label: 'Household has no head of household', slug: 'no_head_of_household',
    severity: 'hp', category: 'Household',
  ...
  {
    id: '3', label: 'Household has more than one head', slug: 'multiple_heads_of_household',
    severity: 'hp', category: 'Household',
  ...
  {
    id: '4', label: 'Relationship to head missing', slug: 'relationship_missing',
    severity: 'hp', category: 'Household',
  ...
  {
    id: '86', label: 'Children-only household', slug: 'children_only_household',
    severity: 'error', category: 'Household',
  ...
  // ── Impossible dates ───────────────────────────────────────────────────────
  {
    id: '14', label: 'Exit date in the future', slug: 'future_exit',
  ...
  {
    id: '99', label: 'Exit before entry', slug: 'exit_before_entry',
    severity: 'error', category: 'Dates',
  ...
  {
    id: '143', label: 'Client older than 100 at entry', slug: 'age_over_100',
  ...
  {
    id: '40', label: 'Move-in outside the stay', slug: 'movein_outside_stay',
    severity: 'error', category: 'Dates',
  ...
  },
  {
    ...
    id: '69', label: 'Homelessness start after entry', slug: 'homeless_start_after_entry',
    severity: 'warning', category: 'Dates',
  ...
  {
    id: '1', label: 'Duplicate enrollment', slug: 'duplicate_enrollment',
    severity: 'hp', category: 'Duplicates',
